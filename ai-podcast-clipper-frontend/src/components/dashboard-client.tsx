  ...
  {(() => {
    ...
    return isSameDay
      ...
      : createdDate.toLocaleDateString("en-GB");
                            ...
                            <TableCell>
                              {item.status === "queued" && (
                                <Badge variant="outline" className="bg-blue-300">Queued</Badge>
                              )}
                              {item.status === "processing" && (
                                <Badge variant="outline" className="bg-yellow-400">Processing</Badge>
                              )}
                              {item.status === "processed" && (
                                <Badge variant="outline" className="bg-green-400">Processed</Badge>
                              )}
                              {item.status === "no credits" && (
                                <Badge variant="destructive" className="bg-amber-500">No credits</Badge>
                              )}
                              {item.status === "failed" && (
